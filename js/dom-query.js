...
let head1font = document.getElementById("head1font");

head1font.addEventListener("click", function(e){
    document.getElementsByTagName('h1')[0].style['fontFamily'] = "courier";
    document.getElementsByTagName('h1')[1].style.fontFamily = "courier";
});

let head2font = document.getElementById("head2font");

head2font.addEventListener("click", function(e) {
    document.getElementsByTagName('h2')[0].style.fontFamily = "Qwitcher Grypen, cursive";
    document.getElementsByTagName('h2')[1].style.fontFamily = "Qwitcher Grypen, cursive";
